#!/usr/bin/env python3
"""Common-row-safe entry point for code-threshold forensics."""
...
EXPERIMENT_SPEC = importlib.util.spec_from_file_location(
    "code_structure_original", HERE / "run_code_structure_forensics.py"
)
if EXPERIMENT_SPEC is None or EXPERIMENT_SPEC.loader is None:
    raise ImportError("cannot load code-structure experiment")
